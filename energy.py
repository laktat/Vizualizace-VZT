...
def summary(values):
    ...
    cop_plant = _div(cool_made, cool_plant_el)
    boiler_eff = _div(heat_made, gas_energy)
    cool_price = _div(cool_plant_el * p_el, cool_made)
    heat_price = _div(heat_plant_cost, heat_made)
    ...
    # tepla z kotelny. Když ještě není z čeho cenu spočítat, použije se plyn.
    ...
    return {
        ...
        "kpi": [
            ...
            {"key": "boiler_eff", "name": "Účinnost kotelny",
             ...
             "unit": "%", "note": "vyrobené teplo z energie ve spáleném plynu"},
